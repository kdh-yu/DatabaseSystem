...
public class RegisterPanel {
    ...
    private JPanel idPanel, namePanel;
    private JPanel passwordPanel;
    private JTextField idInputField, nameInputField;
    ...
    public void registerSuccess() {
        registerButton.setText("Register Success!");
    }
    public void registerFailed() {
        registerButton.setText("Register Failed");
    }
}
